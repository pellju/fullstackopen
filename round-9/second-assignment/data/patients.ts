...
import createNewEntryWithoutId from "../src/utils";
...
const patientEntries: Array<Patients> = data.map(obj => {
    const object = createNewEntryWithoutId(obj) as Patients;
    object.id = obj.id;
    return object;
});
...
import { Patients, Gender } from '../src/types';
